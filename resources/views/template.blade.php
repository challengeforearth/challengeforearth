...
<html lang="en">
    <head>
        ...
        <title>Module Gamification</title>

       {{-- Laravel Mix - CSS File --}}
        <link rel="icon" type="image/png" href="{{ asset(public_path().'images/logo.png') }}" />
        ...
        <link rel="stylesheet" href="{{ mix('css/socialhub.css') }}">
        <link rel="stylesheet" href="{{ mix('css/gamification.css') }}">
    ...
    <div id="app">
        ...
        {{-- Laravel Mix - JS File --}}
        {{-- <script src="{{ mix('js/gamification.js') }}"></script> --}}
    </body>
</html>-->
...
-->
    ...
    <link rel="stylesheet" href="theme/css/example.css">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12 col-sm-12 align-self-center" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <img src="{{ asset('theme/images/left-image.png') }}" class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
    ...
    <script src="theme/js/imgfix.min.js"></script> 
