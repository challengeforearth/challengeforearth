...
Route::post('/forgot-password', [PasswordResetLinkController::class, 'resetPasswordEmail'])
                ->middleware('guest')
                ->name('password.email');

Route::get('/reset-password/{token}', [NewPasswordController::class, 'resetPasswordForm'])
                ->middleware('guest')
                ->name('password.emailform');
